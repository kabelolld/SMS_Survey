...
public class viewForms extends Activity
 {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
	        ...
	        setContentView(R.layout.viewforms);
	        
	        backtoForm = (Button)findViewById(R.id.btnMain3); 
	       ...
	       // llHide = (LinearLayout)findViewById(R.id.LinHide);
	        ...
	        listView = (ListView) findViewById(R.id.ListViewIdForms);
	        ...
	        try
	        {
	        	data = dt.getForms("temp", "temp", "7", "0");
	        ...
	        {
	        	Toast.makeText(viewForms.this, "Couldn't connect to the database. Check if data is enabled.", Toast.LENGTH_LONG).show();
	        }
	        ...
	        backtoForm.setOnClickListener(new View.OnClickListener() 
	        {
	    		...
	    		public void onClick(View v) 
	    		{
	    			...
	    			Intent i = new Intent(viewForms.this,views.class); //calling a class forms
	    			viewForms.this.finish();// close the form class 
	    			startActivity(i);
